	...
	<div class="container-fluid">
		<div class="d-flex">
			<a class="header-brand d-md-none" href="index.html">
				<img src="{{asset('assets/logos/armoirie-burkina-faso.png')}}" class="header-brand-img mobile-icon" alt="logo">
				<img src="{{asset('assets/logos/armoirie-burkina-faso.png')}}" class="header-brand-img desktop-logo mobile-logo" alt="logo">
			</a>
			...
			<div class="d-flex ml-auto header-right-icons header-search-icon">
				...
				<div class="dropdown profile-1">
					<a href="#" data-toggle="dropdown" class="nav-link pl-2 pr-2  leading-none d-flex">
						<span>
								<img src="{{asset('storage/'.Auth::user()->photo)}}" alt="" class="avatar  mr-xl-3 profile-user brround cover-image">
							</span>
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
						<a class="dropdown-item" href="{{route('showusers', Auth::user()->uuid)}}">
							<i class="dropdown-icon mdi mdi-account-outline"></i> Mon Profil
						</a>
						<a class="dropdown-item" href="{{route('edit-user', Auth::user()->uuid)}}">
							<i class="dropdown-icon zmdi zmdi-edit"></i> Editer mon Profil
						</a>
