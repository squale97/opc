...
@section('b-content')
    ...
    <div>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Les secteurs</li>
        </ol>
    </div>
            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                <p>Auccune secteur disponible</p>            
                            </div>             
                            @endif
                        </div>
                        <!-- TABLE WRAPPER -->
                ...
                <div class="col-sm-12 col-md-12 col-lg-4">
                    ...
                    @if (isset($secteur->uuid))
                        <form class="bg-white row p-5 mx-0" method="POST" action="{{route('update-secteur', $secteur->uuid)}}" id="update-user" enctype="multipart/form-data">
                            {{ method_field('PATCH') }} 

                            <h3>Modifier {{$secteur->libelle}}</h3>
                            <hr>
                    @else
                        <form class="bg-white row p-5 mx-0" method="POST" action="{{ route('add-secteur') }}" enctype="multipart/form-data" id="add-user">
                            {{ method_field('POST') }} 
                    ...
                    @endif
                        ...
                        <div class="form-group mb-1 col-12 col-xs-12 mb-5">
                            ...
                            <input type="text"  required name="libelle" value="{{ old('libelle')?? $secteur->libelle }}" id="libelle" placeholder="Libelle de la commune" class="form-control" />
                            @error('libelle')
                            ...
                            <div class="form-group mb-1 col-12 col-xs-12 mb-5">
                                ...
                                <select id="paysId" class="form-control" name="commune_id"  value="{{ old('commune_id') }}" >
                                    ...
                                    @foreach ($communes as $item)                                                                           
                                        <option value="{{$item->uuid}}" @if ($item->uuid == $secteur->commune_id) selected @endif > {{$item->libelle}} </option>
                                    @endforeach
                                </select>
                            </div>
