...
@section('b-content')
    ...
    <div>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Les régions</li>
        </ol>
    </div>
            ...
            <div class="row">
                                ...
                                <table id="data-table1" class="table table-striped table-bordered text-nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{route('edit-region', $item->uuid)}}">{{$item->libelle}}</a></td>
                ...
                <div class="col-sm-12 col-md-12 col-lg-4">
                    ...
                    @if (isset($region->uuid))
                        <form class="bg-white row p-5 mx-0" method="POST" action="{{route('update-region', $region->uuid)}}" id="update-user" enctype="multipart/form-data">
                            {{ method_field('PATCH') }} 
                    @else
                        <form class="bg-white row p-5 mx-0" method="POST" action="{{ route('add-region') }}" enctype="multipart/form-data" id="add-user">
                            {{ method_field('POST') }} 
                    @endif
                        @csrf
                        ...
                        <div class="form-group mb-1 col-12 col-xs-12 mb-5">
                            ...
                            <input type="text"  required name="libelle" value="{{ old('libelle')?? $region->libelle }}" id="libelle" class="form-control" />
                            @error('libelle')
